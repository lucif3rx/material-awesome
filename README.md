...
```
git clone https://github.com/lucif3rx/material-awesome.git ~/.config/awesome
```
...
```
git clone -b awesome4.3-stable https://github.com/lucif3rx/material-awesome.git ~/.config/awesome
```

Awesome4.2
```
git clone -b awesome-4.2 https://github.com/lucif3rx/material-awesome.git ~/.config/awesome
```
